...
<head>
  <meta charset="UTF-8">
  <title>HDFC Home Loan - Rentify</title>
...
<body>
  <div class="container">
    ...
    <div class="section">
      <h2>Features of HDFC Home Loan</h2>
      <ul>
        <li>Loan amount up to ₹75 Lakhs</li>
        <li>Attractive interest rates starting from 8.55% p.a.</li>
        <li>Prepayment and part-payment options available</li>
        <li>Online loan tracking</li>
    ...
    <div class="section">
      ...
      <ul>
        ...
        <li>Salaried or Self-Employed with valid income proof</li>
        <li>Stable employment or business profile</li>
      </ul>
    </div>
    ...
    <div class="section">
      ...
      <ul>
        ...
        <li>Income Proof (Form 16, Salary slips, ITR)</li>
    ...
    <div class="section">
      <h2>Contact HDFC Loan Desk</h2>
      <p>Email: <a href="mailto:hdfc-loan@bank.com">hdfc-loan@bank.com</a></p>
      <p>Phone: 1800-266-4332</p>
      <p>Branch Address: HDFC Tower, Gomti Nagar, Lucknow</p>
    </div>

    <div class="section">
      <h2>Apply for HDFC Home Loan</h2>
      <form action="loan-save.php" method="POST">
        <input type="hidden" name="bank" value="HDFC">
        ...
        <button type="submit">Submit HDFC Loan Application</button>
      </form>
