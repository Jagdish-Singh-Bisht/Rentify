...
<head>
  <meta charset="UTF-8">
  <title>1BHK Flat in Aliganj - Rentify</title>
...
<body>
  <div class="container">
    ...
    <div class="property-info">
      ...
      <div class="property-meta">Semi-Furnished | 600 sq.ft | Ground Floor | North Facing</div>
      <div class="price">₹7,500/month</div>
    </div>
    <div class="details-grid">
      <div class="detail-box"><strong>Property Type:</strong> Flat</div>
      ...
      <div class="detail-box"><strong>Water Supply:</strong> Municipal</div>
      <div class="detail-box"><strong>Parking:</strong> Street</div>
    </div>
    <h2 class="section-title">Property Description</h2>
    <div class="description">
      A compact and affordable 1BHK ideal for bachelors or small families. Close to markets, schools, and has great connectivity.
    </div>
    <h2 class="section-title">Verification Details</h2>
    <div class="description">
      ✔ Rent Agreement Ready<br>
      ✔ Police Verification Done<br>
      ✔ Owner Identity Verified
    </div>
    <div class="contact-card">
      <strong>Landlord:</strong> Mr. Sharma (Verified Owner)<br>
      <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin']): ?>
        📞 Phone: +91 9123456780<br>
        📧 Email: sharma.rentals@email.com
      <?php else: ?>
